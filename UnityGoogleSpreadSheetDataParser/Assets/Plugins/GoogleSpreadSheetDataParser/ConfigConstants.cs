...
namespace GoogleSpreadSheetParser
{
    public class ConfigConstants
    {
        ...
        public static readonly string DownloadPath = "https://docs.google.com/spreadsheets/d/{0}/export?sheet={1}&format=tsv";
        public static readonly string Uri = "https://docs.google.com/spreadsheets/d/{0}/edit?usp=sharing";
        public static string[] TempleteDataTypes = new string[] { "int[]", "long[]", "float[]", "double[]", "string[]", "bool[]", "int", "long", "float", "double", "string", "bool" };

        public static readonly string OriginalExtensionName = ".tsv";
